...
public sealed class LibraryTestFactory : WebApplicationFactory<Program>
{
    ...
    protected override void ConfigureWebHost(Microsoft.AspNetCore.Hosting.IWebHostBuilder builder)
    {
        ...
        builder.ConfigureServices(services =>
        {
            ...
            services.AddSingleton<ColdHarbour.Application.Playback.Ports.IConnectedDeviceStore>(new StubConnectedDeviceStore());
        });
    }
    ...
    private sealed class StubConnectedDeviceStore : ColdHarbour.Application.Playback.Ports.IConnectedDeviceStore
    {
